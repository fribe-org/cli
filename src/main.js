...
export async function createProject(options) {
  ...
  if (options.path != ".") {
    options.targetDirectory = options.targetDirectory + "/" + options.path;
  }
  ...
  const templateDir = path.resolve(
    fullPathName
      .substr(fullPathName.indexOf("C:/"))
      .substr(fullPathName.indexOf("/")),
    "../../templates",
  ...
  const tasks = new Listr(
    [
      ...
      },
      {
        ...
        skip: () =>
          !options.runInstall
            ? "Pass automatically install dependencies"
            : undefined,
      },
    ],
    {
